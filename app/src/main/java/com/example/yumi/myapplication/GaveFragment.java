...
public class GaveFragment extends Fragment {
    ...
    public static GaveFragment newInstance(String text) {



        GaveFragment fragment = new GaveFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // containerにfragment_gave.xmlのレイアウトを追加。
        View view = inflater.inflate(R.layout.fragment_gave, container, false);

        // Keyを使って値を取得。
        String bundleValue = getArguments().getString(FRAGMENT_TEXT);

        // TextViewの値を変更。
        TextView textView = (TextView) view.findViewById(R.id.tabItem1);
